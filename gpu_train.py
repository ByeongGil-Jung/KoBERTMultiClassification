...
if __name__ == "__main__" :
    model = MultiClassification(learning_rate=0.00005, dropout_p=0.5, hidden_size=768, num_classes=3)

    dm = ClassificationDataModule(batch_size=8, train_path='./train.tsv', valid_path='./dev.tsv',
...
# if __name__ == "__main__" :
#     model = MultiClassification(learning_rate=0.0001, dropout_p=0.3, hidden_size=768, num_classes=2, top_k=2)
